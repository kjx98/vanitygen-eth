/*
 * Vanitygen ETG, vanity ETH address generator
...
#define VANITYGEN_VERSION "ETH v1.0"
...
extern vg_context_t *vg_prefix_context_new();
extern double vg_prefix_get_difficulty( const char *pattern);
